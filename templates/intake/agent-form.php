<div class="oksia-intake-container">
    <h2>Create New Quote (Agent)</h2>
    <form id="oksia-agent-intake-form" method="post">
        <?php wp_nonce_field('oksia_frontend_nonce', 'intake_nonce'); ?>
        <input type="hidden" name="form_type" value="agent_intake">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <textarea name="special_requests" rows="3" placeholder="Dietary restrictions, accessibility needs, preferred hotels, etc."></textarea>
            </div>

            <div class="form-group">
                <label>Agent Notes (Internal)</label>
                <textarea name="agent_notes" rows="3" placeholder="Internal notes for agency staff"></textarea>
            </div>
        </div>

        <div class="form-submit">
            <button type="submit" class="submit-btn">Create Quote & Generate Itinerary</button>
        </div>
...
<style>
/* Same styling as client-form.php */
